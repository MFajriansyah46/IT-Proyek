<x-front-layout>
  ...
  <!-- register container -->
    ...
    <form action="/register" method="POST" class="flex flex-col gap-4 w-full mt-8 px-8">
      ...
      <!-- Password field -->
        <div class="relative">
            <input id="password-field" class="p-2 rounded-xl @error('password') border-2 border-red-500 @enderror w-full" type="password" name="password" placeholder="Password" required>
