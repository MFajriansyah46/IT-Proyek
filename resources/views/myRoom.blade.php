<x-public-layout>
    @if($rent)
        <div class="max-w-xl shadow-md min-h-screen bg-white mx-auto">
            ...
            <h2 class="mx-2 my-2 text-xl text-gray-600 font-medium">Room Information</h2>
            <!-- gambar utama -->
            ...
            <h2 class="mx-2 my-2 text-xl text-gray-600 font-medium">Rental Information</h2>
            <div class="mx-2 mt-4 text-gray-600">
                <div class="flex mb-6">
