...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <img src="/images/logo bang raja3.png" class="h-28 w-auto mx-auto" alt="">
    <h2 class="mt-2 text-center text-2xl leading-9 tracking-tight text-gray-900">Login into your account</h2>
  </div>
