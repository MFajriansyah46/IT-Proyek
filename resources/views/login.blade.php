      ...
      <form action="" class="flex flex-col gap-4">
        ...
        <div class="relative">
          <input id="password-field" class="p-2 rounded-xl border w-full" type="password" name="password" placeholder="Password">
            <svg id="toggle-password" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class=" absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer" viewBox="0 0 16 16">
