  ...
  <div class="bg-white rounded-lg shadow-lg p-8 w-100">
    ...
    <form method="post" action="" enctype="multipart/form-data">
      <div class="flex flex-col items-center justify-center mb-6">
        <div class="relative">
          <img class="w-28 h-28 rounded-full border object-cover" id="profileImage" src="" alt=".">
      ...
      <div class="flex justify-center items-center">
        <input type="text" name="" value="" class="text-center border-0  border-b focus:outline-none">
      </div>
    </form>
    ...
    <div class="space-y-4">
      ...
      <!-- Username -->
      <div>
        <p class="text-center text-xl text-gray-800 font-medium">{{ auth()->user()->username }}</p>
      </div>
      ...
      <div>
        ...
        <p class="text-gray-800 font-medium">+628123456789</p>
      </div>

      <!-- Bank Account Number -->
      <div>
        <label class="text-gray-600 text-sm font-semibold">Bank Account Number</label>
        <p class="text-gray-800 font-medium">1234567890</p>
      </div>
    ...
    <div class="mt-6 flex justify-center">
      <button id="closeProfileBtn" class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">
        Tutup
      </button>
    </div>
  </div>
...
<!-- Modal delete user-->
<div id="confirmation-delete-user" tabindex="-1" aria-labelledby="confirmationModalLabel" aria-hidden="true"
  class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 bg-black bg-opacity-50 justify-center flex items-center w-full md:inset-0 h-modal md:h-full">
  <div class="relative p-4 w-full max-w-lg h-full md:h-auto">
    <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
      ...
      <svg class="text-gray-400 dark:text-gray-500 w-16 h-auto my-6 mx-auto" aria-hidden="true" fill="currentColor"
